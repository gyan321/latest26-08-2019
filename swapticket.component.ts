...
import {DisplayserviceService} from '../../Common/displayservice.service';
...
console.log(value);
  ...
  ngOnInit(){
    this.displayserviceService.changeMessage(true);
    console.log("display service after statment");
...
this.swapTicketSavingService.getSwapTicket(this.model2);
  ...
  this.notionalModel.notional=this.model.txtPayNotional;
 // this.model.txtRecNotional=this.model.txtPayNotional;

  this.swapticketService.getNotional(this.notionalModel).subscribe(
    res=>{
      this.obj1=res;
      this.notionalModel.notional=this.model.txtPayNotional;
      console.log(this.notionalModel.notional);
      this.model.txtRecNotional=this.model.txtPayNotional;
